...
def find_verticals(arr, countX, img2):
    if(arr):
        arr.sort()
        counter = arr[0]
        vertical = 0
                ...
                if(num == q):
                    ...
                    if(vertical == 1 and verticalSize <= 1):
                        ...
                        if((abs(currConnection - verticalSize - counter)) >= 7):
                            ...
                            arr2 = [counter, counter - verticalSize - 1]
...
def binaryFile(filename):
    ...
    for arr in unique:
        if(arr[0] != posIndex and arr[0] != 0):
            ...
            find_verticals(currentPos, countX, img2)
            countX = countX + 1
            posIndex = posIndex + 1
            currentPos.clear()
    ...
    print('Fish starting boundaries')
    for asdf in potentialFish:
        print(asdf)

    print('Fish boundaries')
    for f in fish:
        print(f)
